...
const createStyles = (theme: Theme) => StyleSheet.create({
  ...
  totalFocusOptionGrid: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 10,
  },
  totalFocusOptionButton: {
    flexBasis: '48%',
    flexGrow: 1,
    minHeight: 82,
    borderRadius: 14,
  ...
  totalFocusOptionButtonDisabled: {
    opacity: 0.55,
  },
  totalFocusOptionLabel: {
    color: theme.colors.text,
    fontSize: 14,
    fontWeight: '800',
  },
  totalFocusOptionDetail: {
    color: theme.colors.textMuted,
    fontSize: 12,
  },
  blockerDiagnosticsCard: {
    marginTop: 12,
    backgroundColor: theme.colors.surface,
    borderRadius: theme.radius.lg,
    padding: 14,
  ...
  blockerDiagnosticsHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    gap: 12,
  },
  blockerDiagnosticsTitleWrap: {
    flex: 1,
  },
  blockerDiagnosticsTitle: {
    color: theme.colors.text,
    fontSize: 14,
    fontWeight: '700',
  },
  blockerDiagnosticsSubtitle: {
    color: theme.colors.textMuted,
    fontSize: 12,
    marginTop: 4,
  },
  ...
  blockerUnlockTitleWrap: {
    flex: 1,
  },
  blockerUnlockIconWrap: {
    width: 34,
    height: 34,
    borderRadius: 17,
    alignItems: 'center',
  ...
  blockerBlockedChipText: {
    color: theme.colors.text,
    fontSize: 11,
    fontWeight: '700',
  },
  blockerUnlockMetaRow: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    gap: 12,
  },
  blockerUnlockTimerText: {
    color: theme.colors.accent,
    fontSize: 18,
    fontWeight: '800',
    letterSpacing: 0.5,
  },
  blockerDiagnosticChips: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 8,
  },
  blockerDiagnosticChip: {
    borderRadius: 999,
    paddingHorizontal: 10,
    paddingVertical: 6,
    borderWidth: 1,
  },
  blockerDiagnosticChipGood: {
    backgroundColor: 'rgba(34, 197, 94, 0.12)',
    borderColor: 'rgba(34, 197, 94, 0.28)',
  },
  blockerDiagnosticChipWarn: {
    backgroundColor: 'rgba(239, 68, 68, 0.12)',
    borderColor: 'rgba(239, 68, 68, 0.28)',
  },
  blockerDiagnosticChipNeutral: {
    backgroundColor: theme.colors.surfaceSoft,
    borderColor: theme.colors.border,
  },
  blockerDiagnosticChipText: {
    color: theme.colors.text,
    fontSize: 11,
    fontWeight: '700',
  },
  blockerDiagnosticSummary: {
    color: theme.colors.text,
    fontSize: 13,
    lineHeight: 19,
  },
  blockerDiagnosticFacts: {
    gap: 6,
  },
  blockerDiagnosticFact: {
    color: theme.colors.textMuted,
    fontSize: 12,
    lineHeight: 17,
  },
